...
const ActionTypes = {
  ...
  // Agent Hub management (separate from runtime agent state)
  SET_AGENT_HUB_AGENTS: "SET_AGENT_HUB_AGENTS",
  SET_AGENT_HUB_LOADING: "SET_AGENT_HUB_LOADING",
  AGENT_HUB_ADD_AGENT: "AGENT_HUB_ADD_AGENT",
  AGENT_HUB_UPDATE_AGENT: "AGENT_HUB_UPDATE_AGENT",
  AGENT_HUB_REMOVE_AGENT: "AGENT_HUB_REMOVE_AGENT",
  SET_AGENT_HUB_ERROR: "SET_AGENT_HUB_ERROR",
  SHOW_AGENT_HUB_SUCCESS: "SHOW_AGENT_HUB_SUCCESS",
}
